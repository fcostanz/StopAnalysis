...
int MakeHistos(int iSample = 0, int iSR = 6){
  ...
  TString mainDir = "/nfs/dust/cms/user/fcost/store/Bonsai/ControlPlots/";
  ...
  controlRegion[0] = "SearchRegionPreIsoTrackVeto";
  controlRegion[1] = "SearchRegionPostIsoTrackVeto";
  ...
  for (int ievt=0;ievt<N;++ievt){    
	...
	continue;
      ...
      bool allButNJet =                                                  y > yCut && dphimin > dphiCut && drlb1 < drlblCut && phiCorrMet > metCut;
      ...
      allButNJet &= centrality > centralityCut && mlb1 < mlbCut;      
