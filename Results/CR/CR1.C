...
int CR1(){
  ...
  Float_t RWCorrWXSUp = 0.; Float_t RWCorrWXSUpErr = 0.;
  Float_t RWCorrWXSDown = 0.; Float_t RWCorrWXSDownErr = 0.;
  Float_t RWCorrRareXSUp = 0.; Float_t RWCorrRareXSUpErr = 0.;
  Float_t RWCorrRareXSDown = 0.; Float_t RWCorrRareXSDownErr = 0.;
  ...
  Float_t RTopCombWXSUp = 0.; Float_t RTopCombWXSUpErr = 0.;
  Float_t RTopCombWXSDown = 0.; Float_t RTopCombWXSDownErr = 0.;
  Float_t RTopCombRareXSUp = 0.; Float_t RTopCombRareXSUpErr = 0.;
  Float_t RTopCombRareXSDown = 0.; Float_t RTopCombRareXSDownErr = 0.;
  ...
  for(int ilep = 0; ilep < NLep; ilep++){
    ...
    tree[ilep]->Branch( "RWCorrWXSUp", &RWCorrWXSUp);
    tree[ilep]->Branch( "RWCorrWXSUpErr", &RWCorrWXSUpErr);
    tree[ilep]->Branch( "RWCorrWXSDown", &RWCorrWXSDown);
    tree[ilep]->Branch( "RWCorrWXSDownErr", &RWCorrWXSDownErr);
    tree[ilep]->Branch( "RWCorrRareXSUp", &RWCorrRareXSUp);
    tree[ilep]->Branch( "RWCorrRareXSUpErr", &RWCorrRareXSUpErr);
    tree[ilep]->Branch( "RWCorrRareXSDown", &RWCorrRareXSDown);
    tree[ilep]->Branch( "RWCorrRareXSDownErr", &RWCorrRareXSDownErr);
    ...
    tree[ilep]->Branch( "RTopCombWXSUp", &RTopCombWXSUp);
    tree[ilep]->Branch( "RTopCombWXSUpErr", &RTopCombWXSUpErr);
    tree[ilep]->Branch( "RTopCombWXSDown", &RTopCombWXSDown);
    tree[ilep]->Branch( "RTopCombWXSDownErr", &RTopCombWXSDownErr);
    tree[ilep]->Branch( "RTopCombRareXSUp", &RTopCombRareXSUp);
    tree[ilep]->Branch( "RTopCombRareXSUpErr", &RTopCombRareXSUpErr);
    tree[ilep]->Branch( "RTopCombRareXSDown", &RTopCombRareXSDown);
    tree[ilep]->Branch( "RTopCombRareXSDownErr", &RTopCombRareXSDownErr);
  }
  ...
  for (int ilep = 0; ilep < NLep; ilep++){
	...
	tailh[iSample]->SetBinError(1, error);
      ...
      tmph->Add(tailh[3]);
      tmph->Multiply(peakSFh[3]);
      tailW = tmph->GetBinContent(1);
      tailWErr = tmph->GetBinError(1);
